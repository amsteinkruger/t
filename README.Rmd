...
```{r rev, eval = FALSE, code = readLines("./scripts/06_2_rev.R")}
```

# Visualizing Influence of Demand and Substitution

```{r dem, eval = FALSE, code = readLines("./scripts/06_3_dem.R")}
```

# Visualizing Principal Components

```{r pca, eval = FALSE, code = readLines("./scripts/07_pca.R")}
```

# Summarizing Results

```{r sum, eval = FALSE, code = readLines("./scripts/07_sum.R")}
```