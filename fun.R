# ---- fun ----
    ...
    fun = function(par){
      ...
      #   Numbers in 2017.
      n0 = fi_biom_dat %>%
        mutate(n = 1000 * Biomasa / fun_l_w(a_lw, fun_a_l(Edad, linf_al, k_al, t0_al), b_lw)) %>% 
        select(n)
      n0 = n0[[1]]
      #   Catchability.
      ...
      nstart = nsale * (100 / (100 - fun_a_aqmort(a_sale, b1_mort_aq, b2_mort_aq))) * 
        (100 / (100 - fun_a_aqmort(a_sale, b1_mort_aq, b2_mort_aq))) * 
        (100 / (100 - fun_a_aqmort(a_sale, b1_mort_aq, b2_mort_aq)))
      ...
      p = as.numeric(vector(length = t_i - t_0 + 1))  # Build a vector of prices at age.
      ...
      nm0_aq[1] = nstart * (0.01 * fun_a_aqmort(a0_aq[1], b1_mort_aq, b2_mort_aq))
      ns0_aq[1] = nstart * (1 - 0.01 * fun_a_aqmort(a0_aq[1], b1_mort_aq, b2_mort_aq)) # Note leading mortality.
      nt0_aq[1] = ifelse(ns0_aq[1] - fun_ns(cage_size_aq, dens_aq, w0_aq[1]) > 0, ns0_aq[1] - fun_ns(dens_aq, w0_aq[1]), 0)
      n0_aq[1] = nstart - nm0_aq[1] - nt0_aq[1]
      rt0_aq[1] = nt0_aq[1] * w0_aq[1] * f_z * g_z # Fix placeholder variable names.
      y0_aq[1] = w0_aq[1] * n0_aq[1] * d_z * e_z # Fix placeholder variable names. 
      p0_aq[1] = p[1] # Placeholder.
      ...
      nm1_aq[1] = (nstart * (1 - 0.01 * fun_a_aqmort(a1_aq[1] - 1, b1_mort_aq, b2_mort_aq)) - 
                  ifelse(nstart * (1 - 0.01 * fun_a_aqmort(a1_aq[1] - 1, b1_mort_aq, b2_mort_aq) - fun_ns(cage_size_aq, dens_aq, w1_aq[1])) > 0, 
                         nstart * (1 - 0.01 * fun_a_aqmort(a1_aq[1] - 1, b1_mort_aq, b2_mort_aq) - fun_ns(cage_size_aq, dens_aq, w1_aq[1])), 
                         0)) * (0.01 * fun_a_aqmort(a1_aq[1], b1_mort_aq, b2_mort_aq))
      ns1_aq[1] = (nstart * (1 - 0.01 * fun_a_aqmort(a1_aq[1] - 1, b1_mort_aq, b2_mort_aq)) - 
                  ifelse(nstart * (1 - 0.01 * fun_a_aqmort(a1_aq[1] - 1, b1_mort_aq, b2_mort_aq) - fun_ns(cage_size_aq, dens_aq, w1_aq[1])) > 0, 
                         nstart * (1 - 0.01 * fun_a_aqmort(a1_aq[1] - 1, b1_mort_aq, b2_mort_aq) - fun_ns(cage_size_aq, dens_aq, w1_aq[1])), 
                         0)) * (1 - 0.01 * fun_a_aqmort(a1_aq[1], b1_mort_aq, b2_mort_aq))
      ...
      y1_aq[1] = w0_aq[1] * n0_aq[1] * d_z * e_z # Fix placeholder variable names.
      p1_aq[1] = p[1] # Placeholder.
      ...
      for(i in 2:(t_i - t_0 + 1)){
        ...
        nm0_aq[i] = (nstart * h_aq[i - 1] + n0_aq[i - 1] * hinv_aq[i - 1]) * (0.01 * fun_a_aqmort(a0_aq[i], b1_mort_aq, b2_mort_aq)) # Note leading mortality.
        ns0_aq[i] = (nstart * h_aq[i - 1] + n0_aq[i - 1] * hinv_aq[i - 1]) * (1 - 0.01 * fun_a_aqmort(a0_aq[i], b1_mort_aq, b2_mort_aq)) # Note leading mortality.
        ...
        nm1_aq[i] = (nstart * h_aq[i - 1] + n1_aq[i - 1] * hinv_aq[i - 1]) * (0.01 * fun_a_aqmort(a1_aq[i], b1_mort_aq, b2_mort_aq)) # Note leading mortality.
        ns1_aq[i] = (nstart * h_aq[i - 1] + n1_aq[i - 1] * hinv_aq[i - 1]) * (1 - 0.01 * fun_a_aqmort(a1_aq[i], b1_mort_aq, b2_mort_aq)) # Note leading mortality.
