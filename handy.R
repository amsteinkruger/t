...
#results_handy = filter(results, Variable == "Aquaculture Profit" | Variable == "taq" | Variable == "naq" | Variable == "waq" | Variable == "paq" | Variable == "Aquaculture Revenue" | Variable == "Aquaculture Cost")
